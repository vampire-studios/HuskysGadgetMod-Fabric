...
public class ItemUtils {
    ...
    public static NonNullList<Identifier> getModels(Identifier registryName) {
        NonNullList<Identifier> models = NonNullList.withSize(16, new Identifier(registryName.toString()));
        return models;
    }
