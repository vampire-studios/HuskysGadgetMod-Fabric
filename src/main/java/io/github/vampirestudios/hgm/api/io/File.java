...
public class File {
     ...
     * @param name the new file name
     */
    public void rename(String name, Callback<FileSystem.Response> callback) {
        if (!valid)
     ...
     */
    public void delete(Callback<FileSystem.Response> callback) {
        if (!valid)
            throw new IllegalStateException("File must be added to the system before you can rename it");
    ...
    public void copyTo(Folder destination, boolean override, Callback<FileSystem.Response> callback) {
        if (destination == null) {
            if (callback != null) {
    ...
    public void moveTo(Folder destination, boolean override, Callback<FileSystem.Response> callback) {
        if (destination == null) {
            if (callback != null) {
                callback.execute(FileSystem.createResponse(FileSystem.Status.FILE_INVALID, "Illegal folder"), false);
            }
