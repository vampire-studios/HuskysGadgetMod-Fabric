...
public class Window<T extends Wrappable> {
    ...
    public static final Identifier WINDOW_GUI = new Identifier(HuskysGadgetMod.MOD_ID, "textures/gui/application.png");
    ...
    public void render(BaseDevice gui, MinecraftClient mc, int x, int y, int mouseX, int mouseY, boolean active, float partialTicks) {
